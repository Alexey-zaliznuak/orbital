// Package storagenats предоставляет SDK для отправки сообщений в storage через NATS.
package storagenats
...
// Client представляет SDK для публикации сообщений в storage через NATS.
type Client struct {
